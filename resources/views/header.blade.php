  ...
  <body>
          ...
          <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
            ...
            <div class="d-flex align-items-center ms-auto">
              <form action="{{ route('logout') }}" method="POST">
                @csrf
                <button type="submit" class="btn btn-outline-primary">Me déconnecter</button>
              </form>
              <button type="button" class="btn btn-danger ms-5">
                ...
                <span class="visually ">Salut {{Auth::user()->name}}</span>
              </button>
            </div>
          </header>      
        </div>
          ...
          <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
            ...
            <div class="col-md-3 text-end">
              ...
              <a class="navbar-brand" href="{{url('/register')}}">
                <button type="button" class="btn btn-primary ms-5">S'inscrire</button>
              </a>
            </div>
          </header>
        </div>
    ...
    <div class="container">
        ...
        <ul class="nav nav-pills">
            ...
            @auth
              <li class="nav-item"><a href="{{url('/historique')}}" class="nav-link active" aria-current="page">Historique des calculs</a></li>
            @endauth
        </ul>
        </header>
    </div>
    ...
    <br>
    <div class="container">
      <footer class="fixed flex-wrap justify-content-center align-items-center py-3 border-top">
        <div class="fixed align-items-center d-flex justify-content-center">
